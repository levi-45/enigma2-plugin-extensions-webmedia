...
#    print "Here in xbmcaddons-py  addon_path =", addon_path
...
#       print "In xbmcaddon.py addon_path =", addon_path
       addon_path = addon_path.replace("plugin://", "/usr/lib/enigma2/python/Plugins/Extensions/WebMedia/plugins/")
#       print "In xbmcaddon.py addon_path 2 =", addon_path
       addons_path,addon_id=os.path.split(addon_path)
#       print "In xbmcaddon.py addon_path 3 =", addon_path
#       print "In xbmcaddon.py addon_id =", addon_id
...
#    print "addon path params:plugin_path,addons_path,scripts_path,addon_id",plugin_path,addons_path,scripts_path,addon_id
    if item=='plugin_path':
...
#                       print "Here in xbmcaddon-py id =", id
                       if id is not None:## requested from addons or scripts
                             ...
                             self.path=getaddonpath_params("addons_path")+"/"+str(self.id)
#                       print "In xbmcaddon self.id =", self.id 
#                       print "In xbmcaddon self.path =", self.path      
           

	def getLocalizedString(self, idx=" "):
#	     print "In xbmcaddon idx =", idx
             ...
             if not os.path.exists(xfile):
                   ...
                   if not os.path.exists(xfile):
                         ...
                         n4 = fpo.find('"', (n3+1))
                         xtxt = fpo[(n3+1):n4]
#                         print "In xbmcaddon xtxt A=", xtxt
                         return xtxt                   
...
#             print "In xbmcaddon xtxt B=", xtxt
	...
	def getSetting(self,id=None):
	   item = '"' + str(id) + '"'
#           print "In xbmcaddon-py id =", item     
#           print "In xbmcaddon-py self.path =", self.path          
...
#                    print "In xbmcaddon-py line =", line
                    if str(item) in line:
#                            print "In xbmcaddon-py line B=", line
...
#             print "In xbmcaddon xtxt B=", xtxt
	...
	def setSetting(self, id = " ", value = " "):
	   ...
	   item = id
#           print "In xbmcaddon setSetting id =", id 
#           print "In xbmcaddon setSetting value =", value   
#           print "In xbmcaddon setSetting self.path =", self.path          
           xfile = self.path + "/resources/settings.xml" 
           f = open(xfile, 'r').read()
           if item not in f:
...
#                print "get_version xfile =", xfile
                if not os.path.exists(xfile):
                    print "addon has no addon.xml or path wrong",xfile
                    print "self.id",self.id
                    print "addon path",self.path
                    return None
