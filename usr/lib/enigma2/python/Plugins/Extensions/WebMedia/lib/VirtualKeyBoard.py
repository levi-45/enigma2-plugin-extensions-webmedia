...
class WMVirtualKeyBoard(Screen):
    skin='''<screen name="WebMediaVKskin" position="center,center" size="1200,560" zPosition="99" title="Virtual keyboard">
